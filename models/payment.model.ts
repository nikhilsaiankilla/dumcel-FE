...
export const CreditPurchaseModel: Model<ICreditPurchase> =
    mongoose.models.CreditPurchase || mongoose.model<ICreditPurchase>("CreditPurchase", CreditPurchaseSchema);